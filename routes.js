...
async function addUser(req,res){
    ...
    try {
      ...
      `;
      const values = [username, hashpassword, name, orders, image_url, date_of_birth];
...
module.exports={login,getUsers,logout,addUser,getUserDetails,updateUserDetails,blockUser,deleteUser,}